...
It's usually a [code smell](https://en.wikipedia.org/wiki/Code_smell) to break one of the rules of React hooks, but sometimes it can be necessary.
...
In my applications, I like to build a generalized utility component that can be used in multiple places.
